/**
 * Test file for Job: vermon-dep
 */

var assert = require ('assert');
var vermon_dep_SUT = require('../vermon-dep');

var mockedConfig, mockedDependencies;

describe ('vermon-dep test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      vermon_dep_SUT.onRun(config, mockedDependencies, function(err, data){
